import { AfterViewInit, Component, EventEmitter, forwardRef, Input, Optional, Output, Renderer2 } from "@angular/core";
...
@Component({
	...
	providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => InputChipsComponent), multi: true }]
})
export class InputChipsComponent extends InputBaseComponent implements AfterViewInit {
	...
	constructor(@Optional() controlContainer: ControlContainer, private readonly renderer: Renderer2) {
